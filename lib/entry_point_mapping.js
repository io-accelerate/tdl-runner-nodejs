...
const HouseOfCardsSolution = require('./solutions/HOC/house_of_cards_solution');
const AmazingSolution = require('./solutions/AMZ/amazing_solution');
const UltimateSolution = require('./solutions/ULT/ultimate_solution');
