...
import UserInputAction from "./runner/user_input_action.js";
import { getConfig, getRunnerConfig } from "./runner/utils.js";
import EntryPointMapping from "./entry_point_mapping.js";
...
const runner = new TDL.QueryBasedImplementationRunnerBuilder()
  ...
  .withSolutionFor(
    "amazing_maze",
    entryPointMapping.amazing_maze.bind(entryPointMapping),
  )
  .withSolutionFor(
    "array_sum",
    entryPointMapping.array_sum.bind(entryPointMapping),
  )
  .withSolutionFor(
    "checkout",
    entryPointMapping.checkout.bind(entryPointMapping),
  )
  .withSolutionFor(
    "count_lines",
    entryPointMapping.count_lines.bind(entryPointMapping),
  )
  .withSolutionFor(
    "filter_pass",
    entryPointMapping.filter_pass.bind(entryPointMapping),
  )
  .withSolutionFor(
    "fizz_buzz",
    entryPointMapping.fizz_buzz.bind(entryPointMapping),
  )
  .withSolutionFor("hello", entryPointMapping.hello.bind(entryPointMapping))
  .withSolutionFor(
    "increment",
    entryPointMapping.increment.bind(entryPointMapping),
  )
  .withSolutionFor(
    "int_range",
    entryPointMapping.int_range.bind(entryPointMapping),
  )
  .withSolutionFor(
    "inventory_add",
    entryPointMapping.inventory_add.bind(entryPointMapping),
  )
  .withSolutionFor(
    "inventory_get",
    entryPointMapping.inventory_get.bind(entryPointMapping),
  )
  .withSolutionFor(
    "inventory_size",
    entryPointMapping.inventory_size.bind(entryPointMapping),
  )
  .withSolutionFor(
    "letter_to_santa",
    entryPointMapping.letter_to_santa.bind(entryPointMapping),
  )
  .withSolutionFor(
    "rabbit_hole",
    entryPointMapping.rabbit_hole.bind(entryPointMapping),
  )
  .withSolutionFor(
    "render_house",
    entryPointMapping.render_house.bind(entryPointMapping),
  )
  .withSolutionFor("sum", entryPointMapping.sum.bind(entryPointMapping))
  .withSolutionFor(
    "to_uppercase",
    entryPointMapping.to_uppercase.bind(entryPointMapping),
  )
  .withSolutionFor(
    "ultimate_maze",
    entryPointMapping.ultimate_maze.bind(entryPointMapping),
  )
  .withSolutionFor("waves", entryPointMapping.waves.bind(entryPointMapping))
  .create();

TDL.ChallengeSession.forRunner(runner)
