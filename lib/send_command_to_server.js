...
const runner = new TDL.QueryBasedImplementationRunnerBuilder()
    ...
    .withSolutionFor('amazing_maze', entryPointMapping.amazing_maze.bind(entryPointMapping))
    ...
    .withSolutionFor('render_house', entryPointMapping.render_house.bind(entryPointMapping))
    ...
    .withSolutionFor('ultimate_maze', entryPointMapping.ultimate_maze.bind(entryPointMapping))
